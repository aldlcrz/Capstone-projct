/**
 * Customer Tab Layout — Bottom navigation matching CustomerLayout.js
 * Tabs: Home | Cart | Orders | Messages | Profile
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        name="notifications"
        options={{
          tabBarIcon: ({ focused }) => <TabIcon emoji="🔔" label="Alerts" focused={focused} badge={unreadCount} />,
        }}
      />
      <Tabs.Screen
        name="messages"
