...
<div id="profile-root"
    ...
    <div class="w-full max-w-125 lg:max-w-5xl mx-auto transition-all duration-300"
        ...
        {{-- Top Header with Heraldic Laurel Wreath and Home Button on Right --}}
        ...
        <div class="relative w-full max-w-md bg-white rounded-3xl p-6 sm:p-7 shadow-2xl border border-gray-100 space-y-5"
            ...
            <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-[10px] text-gray-400 font-medium">Export Account Data Archive</p>
                    </div>
                </div>
            ...
            <div class="bg-[#FAF7F0] border border-[#EAE1D0] rounded-2xl p-4 text-left space-y-2.5">
                <p class="text-xs text-[#1E1915] font-bold leading-relaxed">
                    You are about to download a secure PDF document containing your account data:
                </p>
                <ul class="text-[11.5px] text-[#78716C] space-y-1.5 list-disc pl-4 font-normal">
                    <li><strong>Personal Profile</strong>: Name, email, mobile number, and saved shipping addresses.</li>
                    <li><strong>Order History</strong>: Placed orders, invoices, and delivery tracking.</li>
                    <li><strong>Reviews &amp; Feedback</strong>: Verified product ratings and testimonials.</li>
                </ul>
            </div>
...
function profileApp() {
    return {
        ...
        addressForm: { recipientName: "{{ addslashes($user->name ?? '') }}", phone: "{{ addslashes($user->mobileNumber ?? '') }}", houseNo:'', street:'', barangay:'', city:'', province:'', region:'', postalCode:'', latitude: 14.2952, longitude: 121.4647, isDefault: false },
        ...
        async selectCity(city) {
            ...
            const postal = this.autoPostalCode(city.name, this.addressForm.province);
            if (postal) {
        ...
        selectBarangay(barangay) {
            ...
            const postal = this.autoPostalCode(this.addressForm.city, this.addressForm.province);
            if (postal) {
                this.addressForm.postalCode = postal;
                this.fieldErrors.postalCode = '';
            }
