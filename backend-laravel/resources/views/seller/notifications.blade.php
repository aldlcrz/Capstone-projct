...
<div class="space-y-8">
                    ...
                    <div class="flex items-start gap-5">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            @if($notification->link)
                                <a href="{{ $notification->link }}" class="inline-flex items-center gap-1 mt-4 text-[10px] font-bold uppercase tracking-widest text-[#C0422A] hover:text-black transition-colors">
                                    View Details
    ...
    @else
        <div class="text-center py-24 bg-white rounded-3xl border border-gray-100 shadow-sm">
            ...
            <p class="text-xs text-gray-500 mb-8 max-w-xs mx-auto">We'll let you know when workshop events occur.</p>
            <a href="/seller/dashboard" class="inline-flex px-8 py-4 bg-[#3D2B1F] text-white rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-[#C0422A] transition-all shadow-lg shadow-black/5">
                Dashboard Home
            </a>
        </div>
    @endif
