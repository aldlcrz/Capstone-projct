                ...
                <div class="space-y-2 pt-2">
                    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;">
                        ...
                        <div style="display:flex;align-items:center;gap:8px;">
                            ...
                            <span style="font-size:12px;font-weight:700;color:#C49520;"
                                  x-show="!selectedCategory && targetGroup">Choose from options below</span>
                        </div>
                    </div>
                    ...
                    <div x-show="targetGroup" class="space-y-3" x-cloak>
                        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2.5 max-h-80 overflow-y-auto p-1 pr-1.5" id="category-cards-container">
                            ...
                            <template x-if="filteredCategories.length === 0">
                                <div class="col-span-full py-8 text-center text-xs text-[#78716C] font-medium" style="background:#FFFFFF;border:1px dashed #E2D9C8;border-radius:16px;">
