        ...
        <div class="bg-white rounded-3xl border border-[#E5DDD5] p-6 sm:p-8 shadow-[0_10px_30px_rgba(60,40,20,0.04)] mb-6">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2 flex-wrap">
                            ...
                            <span class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-amber-50 text-amber-800 border border-amber-200">
                                <span class="w-1.5 h-1.5 rounded-full bg-amber-500 animate-pulse"></span>
                                Pending Verification
                            </span>
                        </div>
                        <p class="text-xs text-gray-500 mt-0.5 font-medium">Artisan Partner: <strong class="text-gray-800">{{ $seller->name }}</strong> · {{ $seller->email }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 p-4.5 rounded-2xl bg-amber-50/70 border border-amber-200/90 text-amber-950 text-xs space-y-2">
                ...
                <p class="text-amber-900 leading-relaxed font-medium">
                    Your artisan seller application is currently pending review. If your verification was previously revoked or requested for updates, please review and attach your valid documents below so our administrators can verify and approve your shop.
                </p>
                @if(!empty($latestAudit) && $latestAudit->reason)
                    <div class="p-3 bg-white/90 border border-amber-200 rounded-xl text-amber-950 text-[11px] font-medium leading-relaxed">
                        <span class="text-gray-400 font-bold block text-[9px] uppercase tracking-wider mb-0.5">Admin Note / Reason:</span>
                        {{ $latestAudit->reason }}
                    </div>
                @endif
            </div>
