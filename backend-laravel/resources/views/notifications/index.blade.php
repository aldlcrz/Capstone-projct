...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="max-h-[calc(100vh-18rem)] overflow-y-auto pr-1 space-y-4 scroll-smooth
        ...
        <div class="group bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 {{ !$notification->isRead ? 'border-l-4 border-l-rust' : '' }}">
            <div class="flex items-start gap-5">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <a href="{{ route('notifications.read-and-redirect', $notification->id) }}" class="inline-flex items-center gap-1 mt-4 text-[10px] font-black uppercase tracking-widest text-rust hover:text-black transition-colors">
                        View Details
