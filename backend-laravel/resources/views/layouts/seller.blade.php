...
<body class="antialiased">
    ...
    <x-spotlight-tour
        ...
        :auto-start="true"
        :steps="[
            ['selector' => '#tour-seller-header-welcome', 'title' => 'Welcome & Overview Toolbar',      'text' => 'This is your artisan command center. Use the date preset dropdown to filter your performance (Today, 7 Days, 30 Days, All Time) or click Export Report to download comprehensive financial sheets.'],
            ['selector' => '#tour-seller-action-items',  'title' => 'Shop Action Items & Inquiries',    'text' => 'Real-time alert indicators requiring immediate artisan attention: New orders placed in the last 24h, products with low inventory needing a restock, buyer feedback/reviews, and unread chat messages.'],
            ...
            ['selector' => '#tour-seller-pipeline',      'title' => 'Order Fulfillment Pipeline',       'text' => 'Tracks your orders through every fulfillment stage: Pending (awaiting action), Custom Fit (made-to-measure bespoke orders), To Ship (in packaging), and Delivered (completed). Click any box to filter orders.'],
            ['selector' => '#tour-seller-revenue-chart', 'title' => 'Revenue Trajectory Bar Graph',     'text' => 'Visualizes your store\'s sales velocity and revenue trends day-by-day. Taller bars indicate peak sales days, helping you spot seasonal trends and high-performing periods.'],
            ['selector' => '#tour-seller-benchmarks',    'title' => 'Artisan Benchmark & Metrics',      'text' => 'Monitors your store\'s reputation and conversion power: Star rating (★), follower count, total catalogue impressions, sales conversion rate %, and loyal repeat customers.'],
            ...
            ['selector' => '#tour-seller-add-product',   'title' => 'Product Catalogue Management',     'text' => 'Click here to list new Barong creations, upload gallery photos, set sizing variations, fabric types, pricing, and stock levels.'],
            ['selector' => '#tour-seller-orders',        'title' => 'Order Processing Hub',             'text' => 'Manage incoming orders, review custom customer body measurements, update shipping statuses, and communicate order progress.'],
            ['selector' => '#tour-seller-policies',      'title' => 'Shop Policies & Shipping Terms',   'text' => 'Configure your custom sizing guidelines, return policies, and location-based shipping fees so buyers know your terms upfront.'],
            ['selector' => '#tour-seller-payout-config', 'title' => 'Commission & Settlements',         'text' => 'Review and settle your platform sales commissions to keep your artisan boutique in good standing and maintain active listings on LumBarong.'],
        ]"
    />
    @stack('scripts')
</body>
