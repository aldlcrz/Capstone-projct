...
<body class="antialiased">
    <div x-data="{ isMobileMenuOpen: false }" class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside class="hidden lg:flex flex-col w-72 h-full bg-white border-r border-[#E5DDD5] shrink-0 shadow-sm">
            <div class="p-6 flex flex-col h-full">
                <!-- App Brand -->
                <div class="mb-8 shrink-0 pb-4 border-b border-[#F0EAE1]">
                    <a href="/superadmin/dashboard" class="flex items-center gap-3 group">
                        <div class="w-10 h-10 rounded-full bg-[#1A1A1A] p-0.5 shadow-sm border border-amber-500/30 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
                            <img src="{{ asset('images/logo-icon.png') }}" alt="LumBarong" class="w-full h-full object-contain rounded-full">
                        </div>
                        <div>
                            <span class="font-serif text-xl font-bold tracking-tight text-[#3D2B1F] block leading-none">LumBarong</span>
                            <div class="flex items-center gap-1 px-2 py-0.5 rounded-full bg-[#C0422A]/10 border border-[#C0422A]/20 text-[#C0422A] font-black tracking-widest text-[8px] w-fit mt-1 uppercase">
                                👑 Super Admin
                            </div>
                        </div>
                    </a>
                ...
                <nav class="flex-1 space-y-6 overflow-y-auto no-scrollbar">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <a href="{{ route('superadmin.dashboard') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.dashboard') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.dashboard') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('superadmin.commissions') }}"
                           class="flex items-center justify-between px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.commissions*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <div class="flex items-center gap-3">
                                <svg class="w-5 h-5 {{ request()->routeIs('superadmin.commissions*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('superadmin.payment-settings') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.payment-settings*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.payment-settings*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-1.5">
                        <div class="text-[10px] font-black text-gray-400 tracking-widest uppercase px-3 mb-2">User Management</div>

                        <a href="{{ route('superadmin.sellers') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.sellers*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.sellers*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('superadmin.customers') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.customers*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.customers*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <a href="{{ route('superadmin.maintenance') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.maintenance*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.maintenance*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('superadmin.audit-logs') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.audit-logs*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.audit-logs*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('superadmin.error-logs') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.error-logs*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.error-logs*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('superadmin.platform') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 text-sm font-medium {{ request()->routeIs('superadmin.platform*') ? 'bg-[rgba(192,66,42,0.08)] text-[#C0422A] border-l-4 border-[#C0422A] font-bold' : 'text-[#3D2B1F] hover:bg-[#F7F3EE] hover:text-[#C0422A]' }}">
                            <svg class="w-5 h-5 {{ request()->routeIs('superadmin.platform*') ? 'text-[#C0422A]' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- User Footer Card -->
                <div class="mt-auto pt-4 border-t border-[#F0EAE1] shrink-0 space-y-3">
                    <div class="flex items-center gap-3 px-1">
                        <div class="w-10 h-10 rounded-xl bg-[#3D2B1F] text-white flex items-center justify-center font-bold text-sm shadow-xs">
                            {{ strtoupper(substr(Auth::user()->name ?? 'Super Admin', 0, 1)) }}
                        </div>
                        <div class="overflow-hidden">
                            <div class="text-sm font-bold text-[#3D2B1F] truncate">{{ Auth::user()->name }}</div>
                            <div class="text-[9px] text-[#C0422A] font-bold uppercase tracking-widest">Super Administrator</div>
                        </div>
                    </div>
