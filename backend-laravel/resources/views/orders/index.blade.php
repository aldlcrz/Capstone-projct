...
<div style="min-height:calc(100vh - 80px);background-color:#FAF8F5;padding:24px 16px 48px 16px;"
    ...
    <div style="max-width:1040px;margin:0 auto;" class="space-y-6 sm:space-y-7">
        ...
        <div class="flex flex-col sm:flex-row sm:items-end justify-between pb-4 border-b border-[#EAE1D0] gap-4">
            <div>
                <div class="flex items-center gap-2 mb-1">
                    <span class="w-2 h-2 rounded-full bg-[#C49520]"></span>
                    <span class="text-[10px] font-black uppercase tracking-widest text-[#8C6212]">Order History</span>
                </div>
            ...
            <form action="/orders/my-orders" method="GET" class="relative w-full sm:w-72">
                <input type="text" name="search" value="{{ request('search') }}"
                       ...
                       class="w-full h-10 pl-9 pr-4 rounded-xl bg-white border border-[#ECE3D2] text-xs font-semibold text-[#1E1915] focus:outline-hidden focus:border-[#C49520] shadow-2xs transition-all">
