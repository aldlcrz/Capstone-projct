            ...
            <div class="lg:col-span-5 flex flex-col-reverse sm:flex-row gap-3 sm:gap-4 items-start">
                ...
                >
                    ...
                    @if($product->is_on_sale && $product->discount_percentage > 0)
                        <div class="absolute top-2 left-2 sm:top-3 sm:left-3 flex flex-col gap-1.5 sm:gap-2 z-10 pointer-events-none">
                            <div class="inline-flex items-center gap-1.5 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full border border-[#A87B10] shadow-[0_0_8px_rgba(180,130,15,0.45),inset_0_1px_0_rgba(230,185,60,0.12)] bg-gradient-to-br from-[#0F0C08] to-[#1C1609] whitespace-nowrap">
                                <img src="/images/logo-icon.png" alt="LumBarong" class="w-3.5 h-3.5 sm:w-4 sm:h-4 rounded-full shrink-0 object-cover">
                                <span class="text-[#DFC97A] text-[7.5px] sm:text-[8.5px] font-bold tracking-tight sm:tracking-wider uppercase">Lumban Special</span>
                            </div>
                            <div class="inline-flex items-baseline px-2 py-0.5 sm:px-3 sm:py-1 rounded-full border border-[#5C3E04] shadow-[0_2px_10px_rgba(200,137,10,0.5),inset_0_1px_0_rgba(255,220,80,0.25)] bg-gradient-to-r from-[#7A5505] via-[#C8890A] to-[#7A5505] whitespace-nowrap self-start">
                                <span class="text-[#FFF8E0] text-[13px] sm:text-[16px] font-black leading-none tracking-tight">-{{ number_format($product->discount_percentage, 0) }}%</span>
                                <span class="text-[#FFE8A0] text-[8px] sm:text-[10px] font-bold uppercase tracking-wider ml-1">OFF</span>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($rec->is_on_sale && $rec->discount_percentage > 0)
                        <div class="absolute top-1.5 left-1.5 sm:top-2 sm:left-2 flex flex-col gap-1 sm:gap-1.5 z-10 pointer-events-none max-w-[calc(100%-12px)]">
                            ...
                            <div class="inline-flex items-baseline px-1.5 py-0.5 sm:px-2.5 sm:py-1 rounded-full border border-[#5C3E04] shadow-[0_2px_10px_rgba(200,137,10,0.5),inset_0_1px_0_rgba(255,220,80,0.25)] bg-gradient-to-r from-[#7A5505] via-[#C8890A] to-[#7A5505] whitespace-nowrap self-start">
                                <span class="text-[#FFF8E0] text-[10px] sm:text-[13px] md:text-[15px] font-black leading-none tracking-tight">-{{ number_format($rec->discount_percentage, 0) }}%</span>
