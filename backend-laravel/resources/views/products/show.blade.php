                ...
                >
                    ...
                    @if($product->is_on_sale && $product->discount_percentage > 0)
                        <div class="absolute top-3 left-3 flex flex-col gap-1.5 z-10 pointer-events-none items-start">
                            <div class="flex items-center gap-1.5 px-3 py-1 rounded-full shadow-lg" style="background: rgba(12, 12, 12, 0.88); backdrop-filter: blur(8px); border: 1.2px solid rgba(212, 175, 55, 0.65);">
                                ...
                                <span class="text-[9px] sm:text-[10px] font-extrabold uppercase tracking-[0.14em]" style="color: #E8D399 !important; text-shadow: 0 1px 3px rgba(0,0,0,0.9);">Lumban Special</span>
                            </div>
                            <div class="flex items-baseline px-3 py-0.5 rounded-full shadow-lg w-fit" style="background: rgba(12, 12, 12, 0.88); backdrop-filter: blur(8px); border: 1.2px solid rgba(212, 175, 55, 0.65);">
                                <span class="text-xs sm:text-sm font-black tracking-tight" style="color: #E5C158 !important; text-shadow: 0 1px 2px rgba(0,0,0,0.9);">-{{ number_format($product->discount_percentage, 0) }}%</span>
                                <span class="text-[9px] sm:text-[10px] font-extrabold uppercase tracking-wider ml-1" style="color: #C5A059 !important; text-shadow: 0 1px 2px rgba(0,0,0,0.8);">OFF</span>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($rec->is_on_sale && $rec->discount_percentage > 0)
                        <div class="absolute top-2.5 left-2.5 flex flex-col gap-1.5 z-10 pointer-events-none items-start">
                            ...
                            <div class="flex items-baseline px-2.5 py-0.5 rounded-full shadow-lg w-fit" style="background: rgba(12, 12, 12, 0.88); backdrop-filter: blur(8px); border: 1.2px solid rgba(212, 175, 55, 0.65);">
                                <span class="text-[9px] font-black tracking-tight" style="color: #E5C158 !important; text-shadow: 0 1px 2px rgba(0,0,0,0.9);">-{{ number_format($rec->discount_percentage, 0) }}%</span>
