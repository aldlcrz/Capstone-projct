                ...
                <tr class="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <button
                                @click="editingCategory = JSON.parse($el.dataset.category); showEditModal = true"
                                data-category="{{ json_encode(['id' => $category->id, 'name' => $category->name, 'description' => $category->description, 'target_group' => $category->target_group ?? []]) }}"
                                class="p-2 text-gray-400 hover:text-black transition-colors" title="Edit Category">
