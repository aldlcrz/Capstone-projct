...
>
    ...
    <div class="flex flex-col sm:flex-row gap-3 relative z-1001">
        ...
        <button
            ...
            :disabled="searching"
            class="bg-[#C0420A] text-white px-8 rounded-2xl text-[10px] uppercase tracking-[0.2em] font-extrabold hover:bg-[#b03b25] transition-all flex items-center justify-center min-h-14 gap-3 shrink-0 shadow-lg disabled:opacity-50"
        >
