...
class ReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'video'       => 'nullable|file|mimes:mp4,mov,avi,webm,mkv,3gp|max:51200',
        ]);
        ...
        // 5. Handle File Uploads (Photos up to 3 & Video max 1)
        $uploadedImages = [];
        if ($request->hasFile('photos')) {
            ...
            $photos = array_slice($request->file('photos'), 0, 3);
            ...
            $uploadedImages = array_slice($request->images, 0, 3);
        }
