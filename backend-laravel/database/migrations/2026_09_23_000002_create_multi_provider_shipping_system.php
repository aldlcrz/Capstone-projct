...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        DB::statement('ALTER TABLE products MODIFY COLUMN shippingFee DECIMAL(10,2) NOT NULL DEFAULT 0');
