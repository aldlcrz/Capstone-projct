...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('shopName')->nullable(); // Add from seed script
            $table->text('shopDescription')->nullable(); // Add from seed script
            ...
            $table->float('shopLatitude')->nullable();
            $table->float('shopLongitude')->nullable();
            ...
            $table->enum('status', ['active', 'frozen', 'blocked', 'rejected'])->default('active');
            $table->text('violationReason')->nullable();
            $table->text('rejectionReason')->nullable();
            $table->integer('sessionVersion')->default(0);
