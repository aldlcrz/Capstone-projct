                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      required
                      className="w-full px-5 py-4 bg-[var(--cream)]/30 border border-(--border) focus:border-[var(--rust)] rounded-2xl outline-none text-[11px] font-bold transition-all shadow-sm"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      required
                      rows="4"
                      className={`w-full px-5 py-4 bg-[var(--cream)]/30 border focus:border-[var(--rust)] rounded-2xl outline-none text-[11px] font-bold transition-all shadow-sm resize-none ${description.length > 0 && description.length < 50 ? 'border-amber-400' : 'border-(--border)'}`}
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <label
                        ...
                        className="flex items-center justify-center gap-3 w-full py-4 bg-white border-2 border-dashed border-(--border) rounded-2xl cursor-pointer hover:border-[var(--rust)] hover:bg-[var(--cream)]/30 transition-all group"
                      >
