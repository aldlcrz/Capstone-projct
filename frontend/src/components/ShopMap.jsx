  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      <div className="relative w-full max-w-2xl bg-white rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col border border-white/20 animate-fade-up">
        {/* Header */}
        <div className="p-6 border-b border-(--border) flex items-center justify-between bg-[#FDFCFB]">
          <div>
          ...
          <button onClick={onClose} className="p-3 bg-white hover:bg-[var(--cream)] rounded-full transition-all border border-(--border) active:scale-95 shadow-sm">
        ...
        {/* Footer */}
        <div className="p-6 bg-[#FDFCFB] border-t border-(--border) flex flex-col sm:flex-row items-center gap-4">
