          ...
          >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-white border-2 border-(--border) text-[var(--charcoal)] py-4 rounded-xl font-bold uppercase text-[10px] tracking-[0.2em] hover:bg-[var(--cream)] transition-all flex items-center justify-center gap-3"
              >
