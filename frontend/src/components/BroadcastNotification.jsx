  ...
  return (
    <AnimatePresence>
      {currentBroadcast && (
        ...
        >
          <div className="pointer-events-auto bg-white border border-(--border) rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] flex items-stretch overflow-hidden max-w-xl w-full min-h-[80px]">
            {/* Accent Side Bar */}
