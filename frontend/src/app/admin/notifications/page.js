      ...
      <div className="max-w-[700px] mx-auto space-y-6 mb-20 px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 pb-2">
          ...
          <button 
            ...
            className="self-start md:mt-4 flex items-center gap-2 px-5 py-2.5 bg-white border border-(--border) rounded-xl text-xs font-bold text-[var(--muted)] hover:text-[#2A2A2A] hover:bg-[#FDFCFB] hover:shadow-sm transition-all shadow-sm"
          >
            <CheckCheck className="w-4 h-4" /> Mark All Read
          </button>
        </div>

        <div className="bg-white rounded-[2rem] shadow-sm overflow-hidden border border-(--border) divide-y divide-[var(--border)] relative">
