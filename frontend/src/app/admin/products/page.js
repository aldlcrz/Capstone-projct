    ...
    <AdminLayout>
      <div className="space-y-6 mb-16 sm:mb-20">
        ...
        <div className="flex flex-col items-center lg:items-start gap-4 sm:gap-6 pb-2 text-center lg:text-left">
          ...
          <div className="flex items-center p-1 sm:p-1.5 bg-white rounded-2xl border border-(--border) shadow-sm w-fit mx-auto lg:mx-0 overflow-x-auto no-scrollbar">
            <button
        ...
        {activeTab === "products" ? (
          <>
            {/* Search Bar */}
            <div className="flex items-center bg-white w-full rounded-2xl px-3 sm:px-5 py-2.5 sm:py-3.5 border border-(--border) focus-within:border-[var(--rust)] shadow-sm transition-all group">
            ...
            <div className="artisan-card p-0 overflow-hidden border-none shadow-xl bg-white/80 backdrop-blur-xl">
              <div className="overflow-x-auto">
                <table className="w-full text-left min-w-max border-collapse">
                  <thead className="bg-[var(--cream)]/40 border-b border-(--border) sticky top-0 backdrop-blur-md">
                    <tr>
                        ...
                        <tr key={product.id} className="group hover:bg-[var(--cream)]/10 transition-colors">
                          <td className="px-4 sm:px-5 py-3 sm:py-4">
                            <div className="flex items-center gap-3 sm:gap-4">
                              <div 
                                className="relative w-10 sm:w-12 h-10 sm:h-12 rounded-lg sm:rounded-xl overflow-hidden bg-[var(--cream)] border border-(--border) shadow-sm shrink-0 cursor-pointer hover:border-[var(--rust)] transition-all"
                          ...
                          <td className="px-5 py-3 sm:py-4 whitespace-nowrap">
                            <div className="flex items-center justify-end gap-1.5 sm:gap-2">
                              <button onClick={() => router.push(`/admin/products/view?id=${product.id}`)} className="p-2 sm:p-2.5 bg-white text-[var(--muted)] hover:text-[var(--rust)] rounded-lg transition-all border border-(--border) shadow-sm hover:border-[var(--rust)]" title="View Listing"><Eye className="w-3.5 sm:w-4 h-3.5 sm:h-4" /></button>
                    ...
                    {loading ? (
                      ...
                      filteredPending.map((product) => (
                        <tr key={product.id} className="group hover:bg-[var(--cream)]/10 transition-colors">
                          <td className="px-4 sm:px-5 py-3 sm:py-4">
                            <div className="flex items-center gap-3 sm:gap-4">
                              <div className="relative w-10 sm:w-12 h-10 sm:h-12 rounded-lg sm:rounded-xl overflow-hidden bg-[var(--cream)] border border-(--border) shrink-0">
                                <Image
                                  src={getProductImageSrc(product.image)}
                                  className="object-cover"
                                  alt={product.name}
                  ...
                  <form onSubmit={handleAddCategory} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-[var(--cream)]/30 border border-(--border) focus:border-[var(--rust)] focus:ring-1 focus:ring-[var(--rust)]/20 rounded-xl outline-none text-[11px] font-black uppercase tracking-wider transition-all shadow-sm"
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        rows="4"
                        className="w-full px-4 py-3 bg-[var(--cream)]/30 border border-(--border) focus:border-[var(--rust)] focus:ring-1 focus:ring-[var(--rust)]/20 rounded-xl outline-none text-[11px] font-bold transition-all shadow-sm resize-none"
                      />
                    </div>
        ...
        >
          <div className="mt-4">
            ...
            <textarea
              ...
              className="w-full mt-2 p-4 bg-[var(--cream)]/30 border border-(--border) rounded-2xl text-xs font-medium outline-none focus:border-red-500 transition-all min-h-[100px] resize-none"
            />
          </div>
        </ConfirmationModal>
        ...
        >
          <div className="mt-4">
            <textarea
              ...
              className="w-full p-4 bg-[var(--cream)]/30 border border-(--border) rounded-2xl text-xs font-medium outline-none focus:border-red-500 transition-all min-h-[100px] resize-none"
            />
          </div>
        </ConfirmationModal>
      </div>
