      ...
      <div className="max-w-5xl mx-auto space-y-6 mb-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 p-1 bg-white/50 backdrop-blur-md border border-(--border) rounded-2xl shadow-sm">
              <button
            ...
            <div className="relative w-full md:w-96 group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3.5 bg-white border border-(--border) rounded-2xl outline-none focus:border-[var(--rust)] transition-all font-bold text-[11px] uppercase tracking-wider shadow-sm"
              />
            </div>
          </div>
        </div>
        ...
        >
          <div className="mt-6 text-left">
            ...
            <textarea
              ...
              className="w-full mt-2 p-4 bg-gray-50 border border-(--border) rounded-2xl text-xs font-medium outline-none focus:border-red-500 transition-all min-h-[100px] resize-none"
            />
          </div>
        </ConfirmationModal>
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 pt-1">
        <div className="min-w-0 flex-1 space-y-1">
          <div className="text-[10px] font-bold text-[var(--charcoal)] flex items-center gap-1.5 truncate border-b border-(--border)/20 pb-1">
