                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-[10px] text-[var(--muted)] font-bold flex items-center gap-1 uppercase tracking-widest mt-0.5"><Calendar className="w-3 h-3" /> Joined Mar 2026</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-8 py-6">
                        <div className="space-y-1.5">
                          ...
                          <div className="text-xs font-medium text-[var(--charcoal)] flex items-center gap-2"><Phone className="w-3.5 h-3.5 text-[var(--muted)]" /> {user.mobile || '+63 9xx xxx xxxx'}</div>
                        </div>
                      </td>
                      <td className="px-8 py-6">
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-green-50 text-green-700 text-[10px] font-bold uppercase tracking-widest rounded-full border border-green-100 italic shadow-sm">
                          <ShieldCheck className="w-3 h-3" /> Active
                        </div>
                      </td>
                      <td className="px-8 py-6 text-right">
                        <div className="flex justify-end gap-2">
                          <button className="p-2.5 text-[var(--muted)] hover:text-red-500 hover:bg-red-50 rounded-xl transition-all" title="Restrict Access">
                            <Ban className="w-4.5 h-4.5" />
                          </button>
                          <button className="p-2.5 text-[var(--muted)] hover:text-[var(--rust)] hover:bg-[var(--cream)] rounded-xl transition-all">
