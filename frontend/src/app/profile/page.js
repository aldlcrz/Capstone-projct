  ...
  return (
    <CustomerLayout>
      <div className="max-w-6xl mx-auto mb-20">
        ...
        {loading ? (
             <div className="bg-white rounded-3xl p-24 text-center text-[var(--muted)] animate-pulse italic shadow-sm">Synchronizing your patron profile...</div>
        ) : (
            ...
            <div className="lg:col-span-4 space-y-6">
               ...
               <div className="bg-white rounded-[2rem] p-10 flex flex-col items-center text-center shadow-sm border border-[var(--border)] relative overflow-hidden">
                  ...
                  <div className="space-y-1 w-full relative z-10">
                    <h3 className="font-serif text-2xl font-bold text-[#2A2A2A]">{user?.name || "Artisan Patron"}</h3>
               ...
               <div className="grid grid-cols-1 gap-6">
                  <div className="bg-white rounded-[1.5rem] p-6 flex flex-col items-center justify-center text-center shadow-sm border border-[var(--border)]">
                     ...
                     <div className="text-[8px] font-bold text-[var(--muted)] uppercase tracking-widest opacity-60 mt-1">ACTIVE COMMISSIONS</div>
                  </div>
               </div>
                      ...
                      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                               <h3 className="font-serif text-2xl font-bold text-[#2A2A2A]">Account Information</h3>
                    ...
                    {activeTab === "Change Password" && (
                      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-8 max-w-xl">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                             <h3 className="font-serif text-2xl font-bold text-[#2A2A2A]">Change Password</h3>
