      ...
      <div className="max-w-2xl mx-auto space-y-6 mb-20 px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 pb-1">
          ...
          <button 
            ...
            className="self-start md:mt-2 flex items-center gap-1.5 px-4 py-2 bg-white border border-(--border) rounded-xl text-[10px] font-bold text-[var(--muted)] hover:text-[#2A2A2A] hover:bg-[#FDFCFB] hover:shadow-sm transition-all shadow-sm"
          >
        ...
        <div className="bg-white rounded-3xl shadow-sm overflow-hidden border border-(--border) divide-y divide-[var(--border)] relative">
