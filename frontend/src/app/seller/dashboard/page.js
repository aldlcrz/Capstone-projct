      ...
      <div className="mb-20 space-y-6 md:space-y-10">
        ...
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end md:gap-6">
          ...
          <div className="flex w-full flex-col-reverse gap-2 sm:flex-row sm:items-center md:w-auto md:gap-3">
            <div className="grid grid-cols-4 items-center gap-1 rounded-xl border border-(--border) bg-white p-1 shadow-sm sm:flex">
        ...
        <AnimatePresence>
          {showRevenueTrend && (
            <motion.div
              ...
              className="rounded-[20px] border border-(--border) bg-white p-3 shadow-sm sm:p-4"
            >
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          <div className="rounded-[24px] border border-(--border) bg-white p-4 shadow-sm sm:p-5 md:p-8 lg:col-span-8">
            <div className="mb-5 flex items-start justify-between gap-3 md:mb-8">
              ...
              <button
                ...
                className={`rounded-xl border p-2 shadow-sm transition-all md:p-2.5 ${showRevenueTrend ? 'bg-[var(--rust)] border-[var(--rust)] text-white' : 'bg-white border-(--border) text-[var(--rust)] hover:bg-[#FAF9F7]'}`}
            ...
            <div className="space-y-3 md:space-y-4">
              {/* Header row */}
              <div className="hidden grid-cols-12 gap-4 border-b border-(--border) px-4 pb-2 text-[10px] font-semibold text-[var(--muted)] md:grid">
          ...
          <div className="rounded-[24px] border border-(--border) bg-white p-4 shadow-sm sm:p-5 md:p-8 lg:col-span-4">
            <div className="mb-6">
        ...
        <div className="mx-auto max-w-3xl rounded-[24px] border border-(--border) bg-white p-4 shadow-sm sm:p-5 md:p-8" key={`funnel-card-${filterKey}`}>
          <div className="mb-6">
