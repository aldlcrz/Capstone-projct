...
class CartProvider with ChangeNotifier {
  ...
  List<CartItem> get selectedItems => _items.where((i) => i.isSelected == true).toList();
  ...
  double get selectedTotal => _items.where((i) => i.isSelected == true).fold(0.0, (sum, i) => sum + i.subtotal);
  bool get allSelected => _items.isNotEmpty && _items.every((i) => i.isSelected == true);
  ...
  void toggleSelection(String productId, {String? color, String? design, String? size}) {
    final idx = _items.indexWhere((i) =>
