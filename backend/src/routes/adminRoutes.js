...
router.put('/customers/:id/freeze', protect, authorize('admin'), adminController.freezeUser);
...
router.put('/sellers/:id/freeze', protect, authorize('admin'), adminController.freezeUser);
